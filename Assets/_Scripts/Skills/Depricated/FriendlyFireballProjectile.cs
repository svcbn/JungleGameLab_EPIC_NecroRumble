...
//
// public class FriendlyFireballProjectile : MonoBehaviour
// {
...
// 	{
//         
// 		if (collision.TryGetComponent<EnemyOldUnit>(out var hitEnemyUnit))
// 		{
//             isHit = true;
//             Debug.Log($"TriggerEnter: {hitEnemyUnit.name}");
// 			
//             hitEnemyUnit.TakeHit(_damage);
// 		}
//
//
//         if(isHit){
