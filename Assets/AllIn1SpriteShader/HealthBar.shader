Shader "CustomShaders/HealthBar"
{
    Properties
    {
        ...
        _highHealthThreshold("high Health Threshold", Range(0,1)) = 1
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float _lowHealthThreshold, _highHealthThreshold, _borderWidth;
            ...
            float4 frag(Varyings IN) : SV_Target
            {
                ...
                // Add flash effect on high life
                if (_healthNormalized > _highHealthThreshold) 
                {
                    float flash = 0.1*cos(6*_Time.y) + 0.1;
                    outColor.xyz += flash;
                } 
