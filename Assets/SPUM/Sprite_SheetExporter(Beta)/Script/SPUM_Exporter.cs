...
public class SPUM_Exporter : MonoBehaviour
{
    ...
    // Start is called before the first frame update
	// private bool takeHiResShot = false; // just to prevent warning log by cyrano

	 public void TakeHiResShot() {
         //takeHiResShot = true; // just to prevent warning log by cyrano
     }
	 ...
	 public void MakeScreenShotFile()
	 {
		...
		// takeHiResShot = false; // // just to prevent warning log by cyrano
		_camera.targetTexture = null;
